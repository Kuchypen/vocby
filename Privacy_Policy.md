...
- User-generated content, such as vocabulary entries, lists, and notes created within the App;
- Technical information, including device type, operating system, app version, and language settings;
...
- store and synchronize user data across devices;
- deliver push notifications related to App functionality;
...
- Supabase, for backend services, authentication, and data storage;
- Expo and Apple Push Notification service (APNs), to deliver push notifications;
- Google AdMob, which may be used in the future to display advertisements.
...
If you are located in the European Union, we will request your consent for personalized advertising in accordance with the General Data Protection Regulation (GDPR) using an approved consent mechanism. You may choose to receive non-personalized ads or withdraw your consent at any time via the App’s settings.
...
We may update this Privacy Policy from time to time. Any changes will become effective when the updated policy is published within the App or otherwise made available to users.
